{**
 * plugins/generic/viewerMultimedia/display.tpl
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2003-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * Embedded viewing of a Viewer Multimedia.
 *}
<!DOCTYPE html>
...
<body class="pkp_page_{$requestedPage|escape} pkp_op_{$requestedOp|escape}">
	...
	<div id="htmlContainer" class="galley_view{if !$isLatestPublication} galley_view_with_notice{/if}" style="overflow:visible;top: 105px;text-align: center;">
